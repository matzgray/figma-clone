...
import banner from "../../public/Rectangle 2.png"
// import { FaSearch } from "react-icons/fa";
// import { CiShoppingCart } from "react-icons/ci";
// import { IoMdPerson } from "react-icons/io";
import logo1 from "../../public/Group.png"
import logo2 from "../../public/zara-logo-1 1.png"
import logo3 from "../../public/gucci-logo-1 1.png"
import logo4 from "../../public/prada-logo-1 1.png"
import logo5 from "../../public/Group (1).png"
import Cards from "@/components/cards";
import topselling1 from "../../public/Frame 32 (1).png"
import topselling2 from "../../public/Frame 33 (1).png"
import topselling3 from "../../public/Frame 34 (1).png"
import topselling4 from "../../public/Frame 38 (2).png"
import fram1 from "../../public/Frame 61.png"
import fram2 from "../../public/Frame 62.png"
import fram3 from "../../public/Frame 64.png"
import fram4 from "../../public/Frame 63.png"
import cumtomer1 from "../../public/Frame 22.png"
import cumtomer2 from "../../public/Frame 61 (1).png"
import cumtomer3 from "../../public/Frame 62 (1).png"
  ...
  return (
    <div>
      <div className="flex flex-wrap w-[100%] my-3 border-2  bg-gray-100">
        ...
        <Image className="w-[80%]   md:w-[40%]  ml-[10%] " src={banner}
          alt="banner"></Image>
      </div>
      ...
      <div><h1 className="text-5xl font-extrabold text-center mt-10">TOP SELLING</h1>
      </div>

      <div className="flex flex-wrap justify-evenly w-[90%] ml-[6%] mt-10">




        <div className="sm:w-[20%] max-w-sm bg-white   shadow dark:bg-gray-800 ">
          <a href="#">

            <Image className="w-[100%]" src={topselling1} alt="card  "></Image>
          </a>
          <div className="px-5 pb-5">
            <a href="#">
              <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">T-SHIRT WITH TAPE DETAILS</h5>
            </a>
        ...
        <div className="sm:w-[20%] max-w-sm bg-white   shadow dark:bg-gray-800 ">
          <a href="#">
            ...
            <Image className="w-[100%]" src={topselling2} alt="card  "></Image>
          </a>
          <div className="px-5 pb-5">
            <a href="#">
              <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">SKINNY FIT JEANS</h5>
            </a>
            <div className="flex items-center mt-2.5 mb-5">
              <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
            ...
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-gray-900 dark:text-white">$240</span>
        ...
        <div className="sm:w-[20%] max-w-sm bg-white   shadow dark:bg-gray-800 ">
          <a href="#">
            ...
            <Image className="w-[100%]" src={topselling3} alt="card  "></Image>
          </a>
          <div className="px-5 pb-5">
            <a href="#">
              <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">CHECKERED SHIRT</h5>
            </a>
            <div className="flex items-center mt-2.5 mb-5">
              <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
            ...
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-gray-900 dark:text-white">$180</span>
        ...
        <div className="sm:w-[20%] max-w-sm bg-white   shadow dark:bg-gray-800 ">
          <a href="#">
            ...
            <Image className="w-[100%]" src={topselling4} alt="card  "></Image>
          </a>
          <div className="px-5 pb-5">
            <a href="#">
              <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">SLEEVE STRIPED T-SHIRT</h5>
            </a>
            <div className="flex items-center mt-2.5 mb-5">
              <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
            ...
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-gray-900 dark:text-white">$130</span>
